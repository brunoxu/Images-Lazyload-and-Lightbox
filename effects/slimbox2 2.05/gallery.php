...
if ( !class_exists( 'Slimbox2_205_Adapater_Gallery' ) ):
class Slimbox2_205_Adapater_Gallery {
...
*/
$obj = new Slimbox2_205_Adapater_Gallery($used_effect,$used_adapter,$application);
