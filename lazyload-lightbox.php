 ...
 * Plugin URI:        http://example.com/lazyload-lightbox-uri/
...
function activate_lazyload_lightbox() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-lazyload-lightbox-activator.php';
...
function deactivate_lazyload_lightbox() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-lazyload-lightbox-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-lazyload-lightbox.php';
